...
"Humanidades":["Historia","Filosofía","Letras"],

"Ciencias Sociales":["Psicología","Derecho","Trabajo Social"],

"Ciencias Médicas":["Medicina","Enfermería","Nutrición"],

"Ciencias Exactas":["Matemática","Física","Química"],

"Tecnología":["Programación","Ingeniería en Sistemas","Ciberseguridad"],

"Ingeniería":["Ingeniería Mecánica","Ingeniería Civil","Ingeniería Industrial"],

"Arte":["Diseño Gráfico","Arquitectura","Música"],

"Ciencias Naturales":["Biología","Veterinaria","Agronomía"]
...
document.getElementById("pregunta").innerHTML=preguntas[indice].texto;
...
document.getElementById("primerLugar").innerHTML=ranking[0][0];
document.getElementById("segundoLugar").innerHTML=ranking[1][0];
document.getElementById("tercerLugar").innerHTML=ranking[2][0];

document.getElementById("descripcion1").innerHTML="Es el área que mejor coincide con tus intereses.";
document.getElementById("descripcion2").innerHTML="También presentás una buena afinidad.";
document.getElementById("descripcion3").innerHTML="Podría ser una opción interesante para tu futuro.";

document.getElementById("barra1").style.width=(ranking[0][1]/4)*100+"%";
document.getElementById("barra2").style.width=(ranking[1][1]/4)*100+"%";
document.getElementById("barra3").style.width=(ranking[2][1]/4)*100+"%";

const lista=document.getElementById("listaCarreras");

lista.innerHTML="";

carreras[ranking[0][0]].forEach(carrera=>{
